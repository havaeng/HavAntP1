/**
 * This class is a Thread. Uses the run()-method to put all the values in the collection of Message via
...
public class Producer extends Thread{
    ...
    /**
     * Constructor.
     * Creates instances of Producer.
     * Requires a collection of Buffer with Message-objects and another collection of Buffer with
     * MessageProducer-objects to instantiate.
     * @param prodBuffer
     * @param messageBuffer
     */
     ...
     * Assigns the variable "mp" of MessageProducer to the return value of producerBuffer.get().
     * This method in turn returns the first value of the collection Buffer<MessageProducer> and deletes it
     * from the collection.
     ...
     * collection.
     * The .put()-method from Buffer reads the next object in Messages[] and tucks it in the Buffer at the
     * last index.
    ...
    @Override
    /*
     * Tips till nästa gång enligt Jenny: lägg till en start()-metod i Producer så att klassen
