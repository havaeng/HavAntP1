...
/**
 * This class translates a provided file from raw data to usable information and creates a Message[] from it.
...
public class TextFileProducer implements MessageProducer {
     ...
     *
     * Constructor for TextFileProducer. To instantiate, a filename or source is required.
     ...
     *
     * An array of Message-objects with the size of times (instance variable) is created. The element of each index
